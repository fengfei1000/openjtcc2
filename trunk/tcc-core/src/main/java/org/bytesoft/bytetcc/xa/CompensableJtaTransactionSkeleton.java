...
public class CompensableJtaTransactionSkeleton implements CompensableTransactionSkeleton {

	private final CompensableJtaTransaction transaction;

	public CompensableJtaTransactionSkeleton(CompensableJtaTransaction tx) {
		this.transaction = tx;
	}
	...
	public CompensableJtaTransaction getTransaction() {
		return transaction;
	}
